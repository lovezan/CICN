...
const Header = () => {
  return (
    <header className="bg-neutral-900 text-white px-4 py-2 sm:px-6 sm:py-4">
        ...
        <div className="flex flex-col sm:flex-row items-center space-x-0 sm:space-x-4">
          ...
          <div className="text-white mt-2 sm:mt-0">
            <div className="text-xs sm:text-sm md:text-lg font-bold">
              IEEE International Conference on Computational Intelligence and Communication Networks
            </div>
