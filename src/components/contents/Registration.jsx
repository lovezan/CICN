  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
        <center>
          <h1 className="text-4xl font-bold text-white mb-6">Registration</h1>
        </center>
        ...
        <div className="overflow-x-auto mb-8">
          <table className="min-w-full bg-black text-white rounded-lg shadow-md border border-gray-700">
            <thead>
            ...
            <tbody>
              ...
              <tr className="bg-gray-800 hover:bg-gray-700">
                ...
                <td className="py-3 px-4 border-b text-center">$250</td>
                <td className="py-3 px-4 border-b text-center">$300 (Two persons)</td>
              </tr>
              <tr className="bg-gray-800 hover:bg-gray-700">
                <td className="py-3 px-4 border-b">Attendance/Co-authors/Companion</td>
        ...
        <div className="text-center">
          <p className="text-lg text-white mb-4"><strong><u>Payment Modes:</u></strong></p>
          ...
          <div className="mb-6">
            ...
            <a 
              ...
              className="inline-block bg-red-500 text-white px-6 py-3 rounded-full shadow-lg hover:bg-red-600 transition duration-300 backdrop-blur-md border border-red-600"
            >
