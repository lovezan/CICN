...
const Sponsors = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-gradient-to-r from-gray-100 to-gray-300 p-6 rounded-lg shadow-xl">
        <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Sponsors and Organizers
        </h1>

        <section className="my-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b border-gray-400 pb-2">
            Organizers
          </h2>
          <div className="flex flex-col md:flex-row items-center md:justify-between mb-6">
            <div className="text-lg text-blue-600 mb-4 md:mb-0">
