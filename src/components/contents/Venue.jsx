  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-gradient-to-r from-gray-700 to-gray-900 p-6 rounded-lg shadow-lg">
        <center>
          <h1 className="text-3xl font-bold text-white mb-6">Conference Venue</h1>
        </center>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-6">
          <img src={sanchi} alt="Sanchi" className="w-48 h-auto object-cover rounded-md shadow-md" />
          <img src={mp1} alt="MP1" className="w-48 h-auto object-cover rounded-md shadow-md" />
          <img src={oa1} alt="OU1" className="w-72 h-auto object-cover rounded-md shadow-md" />
          <img src={iete} alt="IETE1" className="w-36 h-auto object-cover rounded-md shadow-md" />
        </div>
