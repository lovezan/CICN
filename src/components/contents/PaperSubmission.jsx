  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 p-6 rounded-lg shadow-xl">
        <center>
          <h1 className="text-3xl font-bold text-white mb-4">Paper Submission: Open</h1>
          <h3 className="text-xl font-semibold text-green-400 mb-4">Submission Guidelines</h3>
        </center>
        <div className="space-y-4 text-gray-300">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            <img src={pmu2} alt="Image 1" className="w-64 h-40 object-cover rounded-lg shadow-md" />
            <img src={oa1} alt="Image 2" className="w-64 h-40 object-cover rounded-lg shadow-md" />
            <img src={ou2} alt="Oriental University" className="w-64 h-40 object-cover rounded-lg shadow-md" />
          </div>
        </div>
      </div>
    </div>
